        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="grid max-w-4xl lg:max-w-6xl grid-cols-1 mx-auto mt-8 text-center gap-y-4 sm:gap-x-8 sm:grid-cols-2 lg:grid-cols-3 sm:mt-12 lg:mt-20 sm:text-left">
            <div className="relative">
              ...
              <div className="relative overflow-hidden bg-white shadow-md rounded-xl h-full" style={{backgroundImage: 'url("https://slwehdbwpcxuqrwxmwqq.supabase.co/storage/v1/object/public/nft-images/images.jpg")' , backgroundSize:'cover', backgroundPosition:'center'}} >
                <div className="p-9">
                  <svg
